...
namespace Deployer.Lumia
{
    ...
    public class ConservativeLumiaDiskLayoutPreparer : IDiskLayoutPreparer
    {
        ...
        public ConservativeLumiaDiskLayoutPreparer(IDeploymentContext context, IFileSystemOperations fileOperations,
