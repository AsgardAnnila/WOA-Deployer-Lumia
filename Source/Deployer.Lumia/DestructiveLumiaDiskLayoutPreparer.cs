...
namespace Deployer.Lumia
{
    ...
    public class DestructiveLumiaDiskLayoutPreparer : IDiskLayoutPreparer
    {
        ...
        public DestructiveLumiaDiskLayoutPreparer(IDeploymentContext context, IFileSystemOperations fileOperations,
